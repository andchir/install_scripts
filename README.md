...
Если необходимое вам программное обеспечение отсутствует в списке доступных скриптов, вы можете [создать issue](https://github.com/andchir/install_scripts/issues/new) с просьбой добавить скрипт для его установки.
...
| `server_ssh_port` | integer | Нет | SSH-порт (по умолчанию `22`) |
