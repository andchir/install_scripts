...
- Если необходимо создать базу данных для какого-то одного ПО, никогда не используй root пароль и root пользователя, создай нового пользователя и новый пароль с доступом только к одной БД.
